...
pub(crate) use simulation_core::{
    ...
    INVENTORY_ITEMS, ITEM_CHEST, ITEM_COAL, ITEM_COPPER_ORE, ITEM_COPPER_PLATE, ITEM_FURNACE,
    ITEM_IRON_ORE, ITEM_IRON_PLATE, ITEM_NONE, ITEM_STONE, Inventory, ItemId, ObjectId,
    PLACEABLE_ITEMS, PLACED_CHEST, PLACED_FURNACE, PLACED_NONE, PlacedCell, PlacedId, RECIPES,
    RES_COAL, RES_COPPER, RES_IRON, RES_NONE, RES_STONE, Recipe, ResourceCell, ResourceId,
    SimChunkData, SimChunkView, Slot, TileId, WATER_TILE, can_craft, deposit_to_chest,
    deposit_to_furnace_fuel, deposit_to_furnace_input, generate_chunk_data, is_placeable_item,
    is_water, item_name, item_to_placed_kind, object_id_for_tile, placed_at, recipe_for_index,
    resource_at, resource_to_item, smelt_output_for_input, take_from_chest, take_from_furnace,
